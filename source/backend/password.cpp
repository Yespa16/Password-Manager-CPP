...
User* Password::get_user() {return user;}
PasswordGroup* Password::get_group() {return group;}
std::string Password::get_app() {return app;}
std::string Password::get_email() {return email;}
std::string Password::get_username() {return username;}
std::string Password::get_password() {return password;}


void Password::set_id(int _id){id = _id;}
void Password::set_user(User* _u){user = _u; }
void Password::set_group(PasswordGroup* p){group = p;}
void Password::set_app(std::string _app) {app = _app;}
void Password::set_email(std::string _email){email = _email;}
void Password::set_username(std::string _u) {username = _u;}
void Password::set_password(std::string _p){password = _p;}